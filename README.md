# 🚀 CoderHouse Backend 2 - Arquitectura Profesional
...
├── CHECKLIST_PRUEBAS.md # Pruebas a realizar
...
- **[ARQUITECTURA.md](./ARQUITECTURA.md)** - Patrones, rutas, flujos
- **[EJEMPLOS_API.md](./EJEMPLOS_API.md)** - Ejemplos con respuestas
- **[CHECKLIST_PRUEBAS.md](./CHECKLIST_PRUEBAS.md)** - Pruebas por endpoint
- **[RESUMEN_IMPLEMENTACION.md](./RESUMEN_IMPLEMENTACION.md)** - Detalles técnicos
- **[REFERENCIA_RAPIDA.md](./REFERENCIA_RAPIDA.md)** - Comandos esenciales
...
Ver **[CHECKLIST_PRUEBAS.md](./CHECKLIST_PRUEBAS.md)** para pruebas completas de cada endpoint.
...
- [ ] Integración con base de datos real para productos/carritos (actualmente en memoria)
- [ ] Validación de email
